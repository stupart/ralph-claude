...
const ERROR_CODES = {
  ...
  // Executor errors
  ERR_EXECUTOR_BINARY_NOT_FOUND: {
    code: 'ERR_EXECUTOR_BINARY_NOT_FOUND',
    message: 'Claude CLI binary not found: {{message}}',
    category: 'executor'
  },
  ERR_EXECUTOR_NON_ZERO_EXIT: {
    code: 'ERR_EXECUTOR_NON_ZERO_EXIT',
    message: 'Claude process exited with code {{exitCode}}: {{error}}',
    category: 'executor'
  },
  ERR_EXECUTOR_BUFFER_OVERFLOW: {
    code: 'ERR_EXECUTOR_BUFFER_OVERFLOW',
    message: 'Output buffer exceeded {{limit}} limit, truncated',
    category: 'executor'
  }
};
